jQuery(document).ready(function($) {
  ...
  days.owlCarousel({
   	items : 2,					/* updated from 4 to 2 by YuWei */
   	itemsCustom : [[6000,2]],	/* added by YuWei for days item width */
    pagination:false,
    responsiveRefreshRate : 100,
    navigation : true,			/* added by YuWei for set autowidth*/
    /*
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 16,
        center: new google.maps.LatLng(42.3801089,-71.1154016), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(42.3801089,-71.1154016) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Boston Taiwanese Biotech Symposium 2015</b><br/>Northwest Building, Harvard University<br/> Cambridge, MA"  //add your address
    });
